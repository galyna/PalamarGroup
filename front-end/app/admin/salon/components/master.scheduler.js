System.register(["../../../resources/master.resource", "../../../users/services/it.service", "../../../ui/scheduler.service"], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var master_resource_1, it_service_1, scheduler_service_1;
    ...
    return {
        ...
        execute: function() {
            ...
            MasterSchedulerComponentController = (function () {
                function MasterSchedulerComponentController($log, $timeout, $mdDialog, $scope, MasterResource, $routeParams, ItService, SchedulerService) {
                    this.$log = $log;
                ...
                MasterSchedulerComponentController.prototype.initWeekConfig = function () {
                    ...
                    this.weekConfig.onEventClick = function (args) {
                ...
                MasterSchedulerComponentController.$inject = ["$log", '$timeout', "$mdDialog", "$scope", master_resource_1.MasterResourceName, "$routeParams", it_service_1.ItServiceName, scheduler_service_1.SchedulerServiceName];
