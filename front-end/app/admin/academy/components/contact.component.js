    ...
    return {
        ...
        execute: function() {
            ...
            ContactComponentController = (function () {
                function ContactComponentController($log, $routeParams, $mdToast, $timeout, contactResource, constants, photoService) {
                    this.$log = $log;
                ...
                ;
                ContactComponentController.prototype.showErrorToast = function (text) {
                    if (text === void 0) { text = 'Помилка, спробуйте пізніше'; }
                ...
                ContactComponentController.$inject = ["$log", "$routeParams", "$mdToast", "$timeout",
                    contact_resource_1.ContactResourceName, 'constants', photo_service_1.PhotoServiceName];
