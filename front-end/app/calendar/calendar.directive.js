System.register(["./calendar.data.service"], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var calendar_data_service_1;
    function pgCalendarDirective($compile, $parse, $http, $q, pgCalendar, CalendarData) {
        ...
        return {
            ...
            link: function ($scope, $element, $attrs) {
                ...
                var getDayKey = function (date) {
                    return calendar_data_service_1.PgCalendarData.getDayKey(date);
                };
    ...
    exports_1("pgCalendarDirective", pgCalendarDirective);
    return {
        setters:[
            function (calendar_data_service_1_1) {
                calendar_data_service_1 = calendar_data_service_1_1;
            }],
        execute: function() {
