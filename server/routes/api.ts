    ...
    try {
        var pages = [
            ...
            },
            {
                ...
                name: "masters",
                text: "Майстри",
                title: "Майстри салону краси Юлії Паламар PALAMAR GROUP Львів",
                description_ru:"Список команды работников салона с указанием услуг, которую предоставляет мастер и возможностью записатусь на процедуру или консультацию"
            },
            {
